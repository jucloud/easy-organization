...
/**
 * @see https://data.qixin.com/api-detail?categoryId=27C4602EBB38429EK08QR7fy&apiId=35.2&from=qxb-c-api
 */
class BaseinfoLawfirmModule extends GeneralPlugin
{
    ...
    protected function getUri(Rocket $rocket): string
    {
        ...
        return 'lawfirm/getLawfirmDetailByName?' . $query->query();
    }
