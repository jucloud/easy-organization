...
/**
 * @see https://data.qixin.com/api-detail?categoryId=27C4602EBB38429EK08QR7fy&apiId=47.96&from=qxb-c-api
 */
class BaseinfoInstitutionModule extends GeneralPlugin
{
    ...
    protected function getUri(Rocket $rocket): string
    {
        ...
        return 'institution/getPublicInstitutionByName?' . $query->query();
    }
