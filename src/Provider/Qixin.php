...
use JuCloud\EasyOrganization\Plugin\Qixin\CallbackPlugin;
use JuCloud\EasyOrganization\Plugin\Qixin\LaunchPlugin;
use JuCloud\EasyOrganization\Plugin\Qixin\PreparePlugin;
use JuCloud\EasyOrganization\Plugin\Qixin\RadarSignPlugin;
 ...
 */
class Qixin extends AbstractProvider
{
    public const URL = [
        EasyOrganization::MODE_NORMAL => 'https://api.qixin.com/APIService/',
        EasyOrganization::MODE_SANDBOX => 'https://api.qixin.com/APIService/',
        EasyOrganization::MODE_SERVICE => 'https://api.qixin.com/APIService/',
    ];
    ...
    {
        $plugin = '\\JuCloud\\EasyOrganization\\Plugin\\Qixin\\Shortcut\\' . Str::studly($shortcut).'Shortcut';
